...
bool SMCP::IOExport::write_ply(const std::string& filename, const scan3d::Pointcloud& pointcloud, unsigned flags)
{
...
/// <returns>True if the file was written successfully.</returns>
bool SMCP::IOExport::write_xyz(const std::string& filename, const scan3d::Pointcloud& pointcloud, XyzFormat format)
{
