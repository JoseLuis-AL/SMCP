...
SMCP::PointcloudWidget::PointcloudWidget(QWidget* parent)
...
SMCP::PointcloudWidget::~PointcloudWidget()
{
	makeCurrent();
...
void SMCP::PointcloudWidget::initializeGL()
{
...
void SMCP::PointcloudWidget::buildShaders()
{
...
void SMCP::PointcloudWidget::loadPointcloud()
{
...
void SMCP::PointcloudWidget::resizeGL(int w, int h)
{
	if (h == 0) h = 1;
...
void SMCP::PointcloudWidget::updateViewMatrix()
{
	_view.setToIdentity();
...
void SMCP::PointcloudWidget::paintGL()
{
...
void SMCP::PointcloudWidget::mousePressEvent(QMouseEvent* event)
{
	_lastMousePos = event->pos();
	event->accept();
}

void SMCP::PointcloudWidget::mouseMoveEvent(QMouseEvent* event)
{
...
void SMCP::PointcloudWidget::wheelEvent(QWheelEvent* event)
{
