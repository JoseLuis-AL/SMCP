...
namespace SMCP
{
	...
	/// </remarks>
	class PixmapQWidget final : public QWidget
	{
		Q_OBJECT

	public:
		explicit PixmapQWidget(QWidget* parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
		...
		/// <summary>
		/// Alias for setImage(QPixmap) to maintain compatibility with code that calls setPixmap() (e.g. ImageLabel, CaptureQDialog).
		/// </summary>
