...
SMCP::CameraWorker::CameraWorker(CameraPtr camera, const CameraSettings& startSettings, QObject* parent) : QObject(parent),
...
SMCP::CameraWorker::~CameraWorker()
{
	if (!_stopFlag.load(std::memory_order_relaxed)) stop();
}

void SMCP::CameraWorker::start()
{
	try
	{
...
void SMCP::CameraWorker::stop()
{
	_stopFlag.store(true);
}

void SMCP::CameraWorker::acquireLoop()
{
	// Camera dimensions.
...
void SMCP::CameraWorker::onNewCameraBlackLevel(double newValue) const
{
...
void SMCP::CameraWorker::onNewCameraExposureTime(double newValue) const
{
...
void SMCP::CameraWorker::onNewCameraGain(double newValue) const
{
...
void SMCP::CameraWorker::onNewCameraGamma(double newValue) const
{
...
void SMCP::CameraWorker::onAlignmentMode(const bool isActive)
{
	_showCross = isActive;
}

void SMCP::CameraWorker::onNeedToStoreImage(const QString& fileName)
{
	QMutexLocker locker(&_captureMutex);
...
void SMCP::CameraWorker::onStartCapture(const int nPatterns)
{
	QMutexLocker locker(&_captureMutex);
...
void SMCP::CameraWorker::onEndCapture()
{
